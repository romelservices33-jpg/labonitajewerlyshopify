...
// 1. Read the original, perfectly styled index.html
...
// Replace mock cameras in demo cards with real asset images
              ...
              <div class="cutout-card-media">
                <a href="{{ product.url }}" style="display:block; width:100%; height:100%;">
                  {%- if product.featured_image != blank -%}
                    <img src="{{ product.featured_image | image_url: width: 600 }}" alt="{{ product.title | escape }}" class="cutout-card-img" style="width:100%; height:100%; object-fit:cover; display:block;">
                  {%- else -%}
                    <img src="{{ 'collection-cadenas.jpg' | asset_url }}" alt="{{ product.title | escape }}" class="cutout-card-img" style="width:100%; height:100%; object-fit:cover; display:block;">
                  {%- endif -%}
                </a>
