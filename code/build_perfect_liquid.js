...
let imgIndex = 0;
body = body.replace(/<div class="mock-camera-placeholder">[\s\S]*?<\/div>\s*<span class="mock-camera-label">Vista Previa<\/span>\s*<\/div>/g, () => {
...
// Update Hero video with Liquid fallback
body = body.replace(
...
/* Explicit high-specificity overrides to defeat Dawn theme conflicts */
.site-white-footer {
...
/* Enforce solid royal navy hero gradient overlay */
.hero-gradient-overlay {
  ...
  background: linear-gradient(135deg, rgba(8, 25, 91, 0.88) 0%, rgba(47, 36, 159, 0.80) 100%) !important;
  z-index: 2 !important;
...
console.log('SUCCESSFULLY REBUILT PERFECT BONITA LUXURY STOREFRONT LIQUID!');
